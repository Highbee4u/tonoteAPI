...
if(!class_exists('AllowanceType')){

    class AllowanceType {

        private $table = 'allowancetype';
        ...
        public function create($data){
            ...
            $sql = "INSERT INTO ".$this->table. "( `name`, `description`) VALUE ( '".$cleaned_request['allowance_name']."', '".$cleaned_request['description']."')";
        ...
        public function allowance_type_exists($id){
        ...
        public function get_allowance_type_name_by_id($allowanceid){
          $con = connection::getConnection();
  
          $sql = "SELECT name FROM $this->table WHERE  id = '".$allowanceid."'";
